        ...
        if isinstance(carte, CarteMonstre):
            ...
            if Jeu.execute_next_monster and not Jeu.traquenard_actif:
                ...
                if not carte_ignoree:
                    ...
                    # L'ordre est contextuel: reponses precises/reutilisables avant consommables generiques.
                    ...
                    objets_combat = [o for o in joueur.objets if type(o) not in O_COMBAT]
                    objets_combat.sort(key=lambda o: o.score_combat_contextuel(joueur, carte, Jeu), reverse=True)
                    for objet in objets_combat:
