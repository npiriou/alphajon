...
def main():
    ...
    env = Monitor(GymFleeEnv(seed_start=args.seed, opponent_league=args.opponent_league))
    if args.check_env:
        check_env(GymFleeEnv(seed_start=args.seed, opponent_league=args.opponent_league), warn=True)
